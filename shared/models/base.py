"""Shared model base types.

This file migrated from the legacy `shared_models/base.py` into the canonical
`shared.models` package so all runtime imports use a single package path.
"""
