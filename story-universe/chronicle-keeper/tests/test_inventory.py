...
from src.services.inventory import pickup_item, list_inventory, use_inventory_item, equip_inventory_item
from src.services.event_consumer import _apply_item_use_effects, handle_event
